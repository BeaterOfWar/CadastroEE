...
public class ServletProdutoFC extends HttpServlet {
    ...
    private String handleIncludeItem(HttpServletRequest req) {
        try {
            ...
            newProduct.setNomeProduto(name);
            newProduct.setQuantidadeProduto(quantity);
            newProduct.setPrecoVendaproduto(price);
    ...
    private String handleModifyItem(HttpServletRequest req) {
        try {
            ...
            Produto modifyProduct = facade.find(idModify);
            ...
            modifyProduct.setNomeProduto(modifyName);
            modifyProduct.setQuantidadeProduto(modifyQuantity);
            modifyProduct.setPrecoVendaproduto(modifyPride);
